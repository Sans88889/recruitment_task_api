...
Aplikacja jest dostępna publicznie. Można ją przetestować przez interfejs Swagger: Interfejs Swagger w Azure
...
Azure Web App. Dzięki temu całe środowisko można odtworzyć jednym poleceniem.
